    ...
    return (
        <div className="post">
            <div className="post__header">
                ...
                {
                    ( user && username === auth.currentUser.displayName || user && auth.currentUser.email === "roy@gmail.com" )
                    &&
                ...
                {comments.map((comment) => (
                    ...
                    <div className="comment_container">
                        ...
                        <div className="delete__CommentButton" >
                            {
                                ( user && comment.username === auth.currentUser.displayName || user && auth.currentUser.email === "roy@gmail.com" )
                                &&
